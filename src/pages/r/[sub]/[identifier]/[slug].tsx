...
export default function PostPage() {
  ...
  const { data: comments, revalidate } = useSWR<Array<Comment>>(
  ...
  return (
    <>
      ...
      <Link href={`/r/${sub}`}>
        <a>
          <div className="flex items-center w-full p-8 bg-blue-500 height-20">
                    ...
                    >
                      <i
                        className={classNames("icon-arrow-up", {
                          "text-green-600": post.userVote === 1,
                        })}
                      ></i>
                    </div>
                  ...
                  <div className="flex" key={comment.identifier}>
                    ...
                    <div className="flex-shrink-0 w-10 py-2 text-center rounded-l">
                      ...
                      >
                        <i
                          className={classNames("icon-arrow-up", {
                            "text-green-600": comment.userVote === 1,
                          })}
                        ></i>
                      </div>
                    ...
                    <div className="py-2 pr-2">
                      <p className="mb-1 text-xs leadning-none">
                        <Link href={`/u/${comment.username}`}>
                          <a className="mr-1 font-bolb hover:underline">
                            {comment.username}
                          </a>
                        </Link>
